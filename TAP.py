...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.tasks_list_comboBox.addItem("")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.tasks_list_comboBox.setItemText(0, _translate("promfi_dialog", wkbk(self)))
...
def wkbk(self):
    ...
    sht = wb['Sheet1']
    val: sht['a1']
    self.task_codes_comboBox.insertItem(self, p_int=, val)
